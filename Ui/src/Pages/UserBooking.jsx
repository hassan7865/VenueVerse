...
import { DownloadIcon, CalendarIcon, ClockIcon, MapPinIcon, FileTextIcon } from 'lucide-react';
...
const UserBookingsPage = () => {
  ...
  const downloadInvoice = (booking) => {
    try {
      ...
      doc.text(`Time: ${formatTime(booking.startTime)} - ${formatTime(booking.endTime)}`, 20, 111);
      ...
      doc.text(`Generated on: ${new Date().toLocaleDateString()}`, 105, finalY + 27, { align: 'center' });
  ...
  if(bookings && bookings.length == 0){
    ...
    <div className="p-12 text-center">
      ...
      <p className="text-gray-500">You haven't made any bookings yet. Start exploring our services!</p>
    </div>
  </div>
  }
        ...
        <div className="bg-white shadow-xl rounded-2xl overflow-hidden mb-8">
          <div className="bg-brand-blue px-8 py-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-white">{currentUser.username}'s Bookings</h1>
                <p className="text-blue-100 mt-1 text-lg">{currentUser.email}</p>
              </div>
        ...
        <div className="space-y-6">
          {bookings && bookings.length > 0 ? (
            bookings.map((booking, index) => (
              <div key={booking._id} className="bg-white shadow-lg rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <div className="p-8">
                        ...
                        {booking.post?.address && (
                          <div className="flex items-center text-gray-600 md:col-span-2">
                            ...
                            <div>
                              ...
                              <p className="font-semibold">{booking.post.address}</p>
                            </div>
                          </div>
                        )}
                      </div>
