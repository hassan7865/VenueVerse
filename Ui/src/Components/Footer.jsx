            ...
            <div className="relative max-w-7xl mx-auto px-6 py-12 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-8">
                    ...
                    <div className="flex flex-col gap-4">
                        <Link to="/home" className="group flex items-center gap-3 text-white hover:text-blue-400 transition-all duration-300 ease-out">
                            <div className="relative">
                                <div className="absolute inset-0 bg-blue-500/20 rounded-lg blur group-hover:bg-blue-400/30 transition-all duration-300"></div>
                                <svg className="relative w-8 h-8 transform group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M12 3l10 9h-3v9h-6v-6H11v6H5v-9H2l10-9z" />
                                </svg>
                            </div>
                            <span className="font-bold text-2xl tracking-tight text-white">Venue Venture</span>
                        </Link>
                        <p className="text-slate-300 text-sm max-w-md leading-relaxed">
                            Discover and book exceptional venues for your perfect events and memorable experiences.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-8 lg:gap-12">
                        <div>
                            ...
                            <div className="space-y-2">
                                <Link to="/home" className="block text-slate-300 hover:text-white text-sm transition-colors duration-200">Home</Link>
                                <Link to="/venues" className="block text-slate-300 hover:text-white text-sm transition-colors duration-200">Venues</Link>
                                <Link to="/about" className="block text-slate-300 hover:text-white text-sm transition-colors duration-200">About</Link>
                                <Link to="/contact" className="block text-slate-300 hover:text-white text-sm transition-colors duration-200">Contact</Link>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                <Link to="/help" className="block text-slate-300 hover:text-white text-sm transition-colors duration-200">Help Center</Link>
                                <Link to="/privacy" className="block text-slate-300 hover:text-white text-sm transition-colors duration-200">Privacy Policy</Link>
                                <Link to="/terms" className="block text-slate-300 hover:text-white text-sm transition-colors duration-200">Terms of Service</Link>
                            </div>
                        </div>
                    </div>
                ...
                <div className="pt-8 border-t border-slate-700/50">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <div className="text-sm text-slate-400">
                            &copy; {new Date().getFullYear()} Venue Venture. All rights reserved.
                        </div>
