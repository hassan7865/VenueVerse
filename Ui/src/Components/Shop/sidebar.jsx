  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const response = await api.post("/order/create-checkout-session", {
       ...
       const stripe = await (await import("@stripe/stripe-js")).loadStripe("pk_test_51RpWfK7VXE97ki7VAutJgGxO4ELKW9Z7LbkdtICovMZ176hEgRKNglYChD9Jwj32ch0mxx9bFamZht7WaBOfVtWK00H2le7mN5");
